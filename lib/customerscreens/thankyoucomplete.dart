...
class ThankYouComplete extends StatelessWidget {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Sub-message
              Text(
                'Thank You for using our service, we are excited to help you.',
                style: TextStyle(
                  fontSize: 18,
              ...
              // Update message
              Text(
                'The service provider will help you on the date and time of the booking.',
                style: TextStyle(
                  fontSize: 16,
