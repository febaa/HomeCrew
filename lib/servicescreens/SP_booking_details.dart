...
class SPBookingDetails extends StatefulWidget {
  final Map<String, dynamic> booking;

  const SPBookingDetails({Key? key, required this.booking}) : super(key: key);

  @override
  _SPBookingDetailsState createState() => _SPBookingDetailsState();
}

class _SPBookingDetailsState extends State<SPBookingDetails> {
  ...
  Future<void> fetchData() async {
    try {
      await Future.wait([fetchServices(), fetchAddress()]);
    } catch (e) {
